                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="" className="bg-gray-800 text-gray-400">Select Room Type</option>
                            <option value="Classroom" className="bg-gray-800 text-white">Classroom</option>
                            <option value="Lab" className="bg-gray-800 text-white">Lab</option>
                        </select>
                    </div>
